            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <hr style="opacity: 1; border: none; border-top: 20px solid #008081 !important; width: 100%;"> 
                        <div class="m-1">
                            ナンバー：{{ $player->zekken }}
                        </div>
                        <div class="m-1">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <hr> <!-- <hr> 水平線 -->
                        <div class="m-2">
                            三河高原トレイルランニング大会実行委員会殿
                        </div >
                        私は以下の事項について承諾の上参加します。<br>
                        ・私はプログラム記載内容を確認し、本競技の特性を理解した上で参加します。<br>
                        ・競技中の自分の傷病あるいは第三者への損害について自分自身の責任として参加します。<br>
                        ・大会中に主催者あるいは主催者が許可した者が撮影した映像および成績の情報等について、各種メディア、大会報告書等での使用、ならびにエントリー情報の今後の大会広報での使用について同意します。<br>
                        <div class="text-center">
